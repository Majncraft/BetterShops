 ...
 * ************************************************************************
 */
public class SquidNPC extends EntitySquid{

    public SquidNPC(World world) {
        super(world);
    }
    ...
    public static Squid spawn(Location location) {
        ...
        final SquidNPC customEntity = new SquidNPC(
                world);
        ...
        return (CraftSquid) customEntity.getBukkitEntity();
    }
}
