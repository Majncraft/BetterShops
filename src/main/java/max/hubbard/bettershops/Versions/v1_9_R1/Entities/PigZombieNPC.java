 ...
 * ************************************************************************
 */
public class PigZombieNPC extends EntityPigZombie{
    public PigZombieNPC(World world) {
        super(world);
    }
    ...
    public static PigZombie spawn(Location location) {
        ...
        final PigZombieNPC customEntity = new PigZombieNPC(
                world);
        ...
        return (CraftPigZombie) customEntity.getBukkitEntity();
    }
}
