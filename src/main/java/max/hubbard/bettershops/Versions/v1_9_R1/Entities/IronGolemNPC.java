 ...
 * ************************************************************************
 */
public class IronGolemNPC extends EntityIronGolem{
    public IronGolemNPC(World world) {
        super(world);
    }
    ...
    public static IronGolem spawn(Location location) {
        ...
        final IronGolemNPC customEntity = new IronGolemNPC(
                world);
        ...
        return (CraftIronGolem) customEntity.getBukkitEntity();
    }
}
