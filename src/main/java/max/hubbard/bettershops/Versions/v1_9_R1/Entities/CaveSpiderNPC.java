 ...
 * ************************************************************************
 */
public class CaveSpiderNPC extends EntityCaveSpider{
    public CaveSpiderNPC(World world) {
        super(world);
    }
    ...
    public static CaveSpider spawn(Location location) {
        ...
        final CaveSpiderNPC customEntity = new CaveSpiderNPC(
                world);
        ...
        return (CraftCaveSpider) customEntity.getBukkitEntity();
    }
}
